        ...
        <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <a href="#" class="flex items-center">
                    <img src="https://github.com/sparrow-js/ant-codeAI/assets/59440091/c3b98db8-def4-4eff-a94c-4feb418ccc7a" class="h-6 mr-3 sm:h-9" alt="Landwind Logo" />
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            ...
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src="https://github.com/sparrow-js/ant-codeAI/assets/59440091/57a7554a-d2d0-4f31-8897-e82f64931867" alt="hero image">
            </div>                
        </div>
    </section>
    <!-- End block -->
    ...
    <section class="bg-gray-50 dark:bg-gray-800">
        <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
            ...
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                ...
                <img class="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex" src="https://github.com/sparrow-js/ant-codeAI/assets/59440091/cfd954f0-8a21-4957-a777-c7c43d751d0f" alt="dashboard feature image">
            </div>
            <!-- Row -->
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                <img class="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex" src="https://github.com/sparrow-js/ant-codeAI/assets/59440091/801d8587-7f64-42f1-bb9a-5543320b7892" alt="feature image 2">
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
